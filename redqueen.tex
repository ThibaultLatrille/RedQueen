...
\end{eqnarray}
For fixed $\dfrac{\rho}{\mu} = \epsilon$, \replaced{the self-consistent relation thus has a unique solution (figure 6, in the case of a power-law fitness function), and the self-consistent relation thus has a unique solution}{$g$ is a strictly monotonous function, ranging from 0 to $+\infty$ (figure 6, in the case of a power-law fitness function), and the self-consistent relation thus has a unique solution}. This solution can be obtained numerically, giving an estimate for $\R$.
...
\end{figure*}
\textbf{Figure 9.} \replaced{Mean fraction of active targets $H$}{Mean recombination activity $\R$}, calculated under the generalized mean-field approximation, as a function of effective population size $N_e$ (A), erosion rate $vg$ (B), mutation rate at the PRDM9 locus $u$ (C) and the fitness parameter $\alpha$ (D) under the power-law fitness model and with variance in hot spot strength, with shape parameter $a=0.5$, $1$, $5$ and $+\infty$.
...
\end{figure*}
\textbf{Figure S1.} \replaced{Mean recombination activity $\R$}{Mean fraction of active targets $H$}, as a function of effective population size $N_e$ (A), erosion rate $vg$ (B), mutation rate at the PRDM9 locus $u$ (C) and the fitness parameter $\beta$ (D) under the exponential fitness model. Mean-field approximations, either linearized (orange) or generalized (red) and weak erosion approximation (green) are shown on the top of the mean and variance over the simulations (blue).
